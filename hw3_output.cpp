...
void output::printLog(const string string_to_print)
{
    *log_file << string_to_print << endl;
}

void output::printProductionRule(int rule)
{
    string string_to_print = "printProductionRule " +to_string(rule);
    printLog(string_to_print);
}

void output::printInt(int int_to_print)
{
    cout << "printInt " << int_to_print << endl;
}
